...
namespace lab5VP
{
    public partial class Form3 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            String OrderDate = textBox6.Text;
            String OrderQuantity = textBox7.Text;
            ...
            String query = "INSERT INTO myOrder(Customer_Id,OrderDate,OrderQuantity) VALUES ('" + Customer_Id + "' , '" + OrderDate + "' , '" + OrderQuantity + "')";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("Select * from myOrder", con);
            con.Open();
